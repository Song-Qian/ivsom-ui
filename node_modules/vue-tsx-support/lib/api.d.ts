...
export interface ComponentFactory<BaseProps, EventsWithOn, ScopedSlotArgs, AdditionalThisAttrs, Super extends Vue> {
    create<Props, PropsDef extends RecordPropsDefinition<Props>, RequiredProps extends keyof Props = RequiredPropNames<PropsDef> & keyof Props>(options: FunctionalComponentOptions<Props, PropsDef & RecordPropsDefinition<Props>>, requiredProps?: RequiredProps[]): TsxComponent<Super, PropsForOutside<Props, RequiredProps> & BaseProps, EventsWithOn, ScopedSlotArgs, Props>;
    create<Data, Methods, Computed, Props, PropsDef extends RecordPropsDefinition<Props>, RequiredProps extends keyof Props = RequiredPropNames<PropsDef> & keyof Props>(options: ThisTypedComponentOptions<AdditionalThisAttrs & Super & Vue, Data, Methods, Computed, Props> & {
        props?: PropsDef;
...
export declare const component: {
    <Props, PropsDef extends RecordPropsDefinition<Props>, RequiredProps extends keyof Props = { [K in keyof PropsDef]: PropsDef[K] extends {
        required: true;
    } ? K : never; }[Extract<keyof PropsDef, string>] & keyof Props>(options: FunctionalComponentOptions<Props, PropsDef & RecordPropsDefinition<Props>>, requiredProps?: RequiredProps[] | undefined): VueConstructor<{
        _tsxattrs: TsxComponentAttrs<{ [K in RequiredProps]: Props[K]; } & { [K in Exclude<keyof Props, RequiredProps>]?: Props[K] | undefined; }, {}, {}>;
    } & Vue & Props>;
    <Data, Methods, Computed, Props, PropsDef extends RecordPropsDefinition<Props>, RequiredProps extends keyof Props = { [K in keyof PropsDef]: PropsDef[K] extends {
        required: true;
    } ? K : never; }[Extract<keyof PropsDef, string>] & keyof Props>(options: object & ComponentOptions<Vue, import("vue/types/options").DataDef<Data, Props, Vue>, Methods, Computed, RecordPropsDefinition<Props>, Props> & ThisType<import("vue/types/vue").CombinedVueInstance<Vue, Data, Methods, Computed, Readonly<Props>>> & {
